...
try:
    ...
    print('[!] Error: Required packages are needed to be installed agar chahte ho ki ye kam kare!!!')
...
def checkinternet():
    ...
    try:
        ...
        res = True
    if res:
        print("\n\n\tConnection got intrupted or too slow :( ...")
        print('\t\tCrashing...\n\n')
        banner()
        exit()
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        print("==================================================================")
        print("                Lawding in progress, please wait !!               ")
        print("          Please donot disconnect or else script will crash !!    ")
        print("==================================================================")
        ...
        print("             This Bomber Was Created By Bapu BC !!                ")
        print("==================================================================")
        try:
...
while True:
    ...
    if len(cc) >= 4 or len(cc) < 1:
        print('\n\nInvalid Country Code..\n\t\tCountry Codes Are Generally 1-3 digits....Sabse agey wale...\n')
        continue
    if len(pn) <= 6:
...
if pn.strip() == '' or dl <= 0 or nm < 0:
    ...
    exit()
if type == 1:
    print("NOTE: Call Bomb Might Not Work on chutiye Numbers...\n")
...
if nm == 0:
    ...
    print(random.choice(colors))
    print("\n\n==================================================================")
    print("                Gearing Up Lawda, please wait !!               ")
    print("      Please donot disconnect or else script will crash !!     ")
    print("==================================================================")
    ...
    while True:
        ...
        if int(l) > maxlim:
            print('\n\n\tSorry Due To restrictions Of This Script We Only Provide ' +
                  str(maxlim) + ' SMS At Once...\n\n')
            input('Press Enter To Exit...')
            os.system('rm *xxx* > /dev/null 2>&1')
            banner()
